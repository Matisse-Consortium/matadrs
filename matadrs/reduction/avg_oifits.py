    ...
    for infile in infile_list:
        ...
        if os.path.exists(infile):
            ...
            if not avg_cflux:
                ...
                visamp_lst.append(np.nanmean(visamp, axis=0))
                visamperr_lst.append(np.nanmean(visamperr, axis=0))
                visphi_lst.append(np.nanmean(visphi, axis=0))
                visphierr_lst.append(np.nanmean(visphierr, axis=0))
                visamp_sta_index_lst.append(sta_index[0])
                visamp_ucoord_lst.append(0.0)
                visamp_vcoord_lst.append(0.0)
...
def oifits_restrict_wavelengths(infile_path: Path, outfile_path: Path,
    ...
    if do_flag:
        ...
        if 'OI_VIS2' in hdu:
            ...
            oi_vis2_hdu = fits.BinTableHDU.from_columns([c1, c2, c3, c4, c5, c6, c7, c8, c9, c10],
        ...
        if 'OI_T3' in hdu:
            ...
            oi_t3_hdu = fits.BinTableHDU.from_columns([c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14],
        ...
        if 'OI_VIS' in hdu:
            ...
            oi_vis_hdu = fits.BinTableHDU.from_columns([c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12],
        ...
        if 'TF2' in hdu:
            ...
            oi_tf2_hdu = fits.BinTableHDU.from_columns([c1, c2, c3, c4, c5, c6, c7, c8],
                                                       name='TF2', nrows=NV2, fill=True)
        ...
        if 'OI_FLUX' in hdu:
            ...
            oi_flux_hdu = fits.BinTableHDU.from_columns([c1, c2, c3, c4, c5, c6, c7, c8],
                                                        name='OI_FLUX', nrows=NF, fill=True)
